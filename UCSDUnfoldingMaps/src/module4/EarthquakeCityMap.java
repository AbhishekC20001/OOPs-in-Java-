 ...
 * Date: July 17, 2015
 * */
//https://github.com/xiaomei7/Coursera_Object_Oriented_Programming_in_Java/blob/master/OOPJ/UCSDUnfoldingMaps/src/module4/EarthquakeMarker.java
//https://github.com/Schitiz/Coursera-UC_SanDiego-Object-Oriented-Programming-in-Java/blob/master/module4/EarthquakeCityMap.java
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) { 
			...
			sum=sum+counter1;
			System.out.println(name+": "+counter1);
			 
		}
		System.out.println("OCEAN QUAKES: "+ (quakeMarkers.size()-sum));
